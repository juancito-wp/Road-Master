-- ==========================================================
-- Road Master — Script de base de datos para Railway
-- Igual a database.sql pero sin CREATE DATABASE / USE:
-- en Railway la base de datos ya existe (se llama "railway")
-- y se conecta uno directamente a ella.
--
-- Cómo usarlo:
--   1. Railway → tu servicio MySQL → pestaña Data / Query
--      y pega este script completo, O
--   2. Desde tu máquina:
--      mysql -h <HOST> -P <PORT> -u root -p railway < database-railway.sql
-- ==========================================================
